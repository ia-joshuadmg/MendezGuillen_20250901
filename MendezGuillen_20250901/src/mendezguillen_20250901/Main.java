 ...
 */
package mendezguillen_20250901;
...
public class Main {
    ...
    public static void matriz()
    {
        ...
        //SALIDA AL USUARIO PARA INDICAR QUE DEBE INDICAR DATOS//
        ...
        //DEBIDO A QUE DEBEMOS OBTENER EL VALOR DE CADA CELDA (FILA Y COLUMNA)//
            for (int j = 0; j < matriz[i].length; j++){
               ...
               //SE IMPRIME LA PETICION AL USUARIO PARA EL INGRESO DE DATOS//
                ...
                //SE HACE LA LECTURA DE TECLADO//
                matriz[i][j] = scanner.nextInt();
                
            } //CIERRE DEL "FOR" PARA OBTENER COLUMNAS//
        } //CIERRE DEL "FOR" PARA OBTENER LAS FILAS//
        
        //SALIDA DE VALOR PARA EL USUARIO//
